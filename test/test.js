...
var stores = ['localStorage', 'sessionStorage', 'cookieStorage'];

stores.forEach(function (store) {
    describe('CrossStorageClient (store: ' + store + ')', function() {
        ...
        before(function(done) {
            ...
            storage = new CrossStorageClient(url, {timeout: 10000, store: store});
        });
